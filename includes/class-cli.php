...
final class Simula_Security_Telemetry_CLI {
    ...
    public function status() {
        ...
        $rows    = [
            ...
            ['field' => 'firewall_summary_source_detected', 'value' => empty($state['firewall_blocks_available']) ? 'no' : 'yes'],
            ['field' => 'firewall_summary_schema', 'value' => (string) ($state['firewall_blocks_schema'] ?? 'unknown')],
            ['field' => 'firewall_summary_collection_success', 'value' => empty($state['firewall_blocks_collection_success']) ? 'no' : 'yes'],
            ['field' => 'firewall_summary_last_success', 'value' => Simula_Security_Telemetry_Settings::format_state_time($state['firewall_blocks_last_success'] ?? null)],
            ['field' => 'firewall_summary_error_type', 'value' => (string) ($state['firewall_blocks_error_type'] ?? '')],
            ['field' => 'wordfence_block_metric_distinction', 'value' => 'blocked_hit_rows uses retained hit/live-traffic rows; firewall_blocks uses aggregate Firewall Summary buckets.'],
